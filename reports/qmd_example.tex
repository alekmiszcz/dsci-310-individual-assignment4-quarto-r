...
packages were used to perform the analysis: knitr (Xie (2014)),
tidyverse (Wickham (2017)), and Quarto (Allaire et al. (2022)).
...
\caption{\label{fig-horse-pops}Horse populatio\#\textbar{} ns for all
provinces in Canada from 1906 - 1972.}

\end{figure}%

Figure Figure~\ref{fig-horse-pops}: Horse populations for all provinces
in Canada from 1906 - 1972.

We can see from Figure~\ref{fig-horse-pops}, Ontario, Saskatchewan and
