...
Government of Canada's Open Data website (@horses1; @horses2)
...
#| fig-cap: "Horse populatio#| ns for all provinces in Canada from 1906 - 1972."
#| fig-width: 7
knitr::include_graphics("../results/horse_pops_plot.png")
```


Figure @fig-horse-pops: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from @fig-horse-pops, Ontario, Saskatchewan and Alberta 
